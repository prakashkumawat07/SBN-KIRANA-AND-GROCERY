...
import {
  ...
  payLaterCustomers,updatePayLater,recordPayLaterPayment,stock,updateStock,reports,
...
r.get('/paylater',payLaterCustomers);r.patch('/paylater/:id',updatePayLater);r.post('/paylater/:id/payment',recordPayLaterPayment);

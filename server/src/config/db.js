...
export async function connectDB(){
  ...
  const uri=process.env.MONGO_URI||process.env.MONGODB_URI||process.env.MONGODB_URL||process.env.ATLASDB_MONGODB_URI||process.env.ATLASDB_URL||process.env.STORAGE_URL;

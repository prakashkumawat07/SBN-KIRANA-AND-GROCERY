...
const pages={
  ...
  'responsible-credit':['Responsible Credit','Use PayLater only for purchases you can repay by the shown due date. Store management may reduce, suspend or close PayLater access when necessary after manual review.'],
  'recovery-policy':['PayLater Payment Recovery Policy','If a PayLater balance becomes due, SBN Kirana may use reasonable reminders such as phone, message or email and may ask you to confirm a repayment date. Account limits may be reduced or PayLater may be suspended after manual review. Any home visit should be pre-notified, respectful and only used where lawful. Customers may raise a payment or account dispute at any time through Contact Support. A legal-review status means the store is internally reviewing available lawful options; it does not mean legal proceedings have automatically started. Payments are credited only after the store confirms receipt. SBN Kirana does not support harassment, intimidation, public shaming, repeated unwanted contact or misleading threats.'],
